...
from graphs.nets.nn import EfficientNet
...
class ClsAgent(BaseAgent):
    def __init__(self, cfg):
        ...
        # eff_v2
        args = DotMap(dict(benchmark=False, distributed=False, local_rank=0, rank=0, test=False, tf=False, train=False))
        self.model = EfficientNet(args, num_class=3).to(self.device)
        self.image_size = 288
